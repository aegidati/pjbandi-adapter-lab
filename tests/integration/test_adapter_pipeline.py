...
def test_mimit_adapter_pipeline_from_paginated_fixture(monkeypatch) -> None:
    listing_page0 = Path("tests/fixtures/mimit/listing_page0.html").read_bytes()
    listing_page1 = Path("tests/fixtures/mimit/listing_page1.html").read_bytes()
    detail_html = b"""<!DOCTYPE html>
<html><body>
    <h1>Fondo straordinario editoria 2025</h1>
    <p>Pubblicazione: 03/06/2026</p>
